...
5. **C++ Implementation**: Finally to identify the otimal data structure in C++ and to compare the results of dynamic languages to the optimization of a compiled language, the classes were reimplemented in C++.
